...
1. Clone the repository:
    ```bash
    git clone https://github.com/MahmoudAlshaer/Web-Project.git
    ```
...
## Contact
If you have any questions or comments about my CI/CD Pipeline project, please contact:
MahmoudAlshaer - [Mahmoudalshaer8.a@gmail.com](mailto:Mahmoudalshaer8.a@gmail.com)
